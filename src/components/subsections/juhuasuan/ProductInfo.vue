  ...
  <div class="task-plan-section">
    ...
    <blockquote v-show="section_open">
      <div class="form-horizontal tasi-form" role="form">
        ...
        <!--<div class="form-group">-->
          <!--<label class="col-lg-2 control-label">-->
            <!--<strong>聚划算淘口令</strong>-->
          <!--</label>-->
          <!--<div class="col-lg-7" :class="{'has-error': validation.hasError('product_info.token'), 'has-success': validation.isPassed('product_info.token')}">-->
            <!--<input v-model="product_info.token" placeholder="请输入聚划算开团提醒页面的淘口令" class="form-control" type="text">-->
            <!--<div class="help-block text-danger" v-if="validation.hasError('product_info.token')">-->
              <!--<i class="icon icon-times-circle color-red"></i>-->
              <!--{{ validation.firstError('product_info.token') }}-->
            <!--</div>-->
          <!--</div>-->
          <!--<div class="col-lg-10 col-lg-offset-2 clearfix">-->
        ...
        <div class="form-group">
          <label class="col-lg-2 control-label">
            <strong>聚划算开团时间</strong>
          </label>
          <div class="col-lg-6" :class="{'has-error': validation.hasError('product_info.begin_time'), 'has-success': validation.isPassed('product_info.begin_time')}">
            <div>
              <input :value="product_info.begin_time" class="form-control juhuansuan-begin-time-picker inline-block per50" type="text">
